<div>
    <?php if (isset ( $errorMessage ) && $errorMessage !="" ) echo "<ul class='alert alert-danger'>" . $errorMessage . "</ul>"; ?>
    <form class="form-signin" method="post" action="/user/register">
        ...
        <div class="form-group">
            <input type="password" name="password2" value="" class="form-control" placeholder="repeat password">
        </div>
        <div class="form-group">
            <div class="inline-list">
                <input class="btn btn-success" type="submit" name="submit" value="Register"> <a class="btn btn-warning" href="<?php if(isset($backurl)) echo $backurl;?>">Cancel</a>
            </div>
        </div>
